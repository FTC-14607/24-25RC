...
import static rrpathgen.RRPathGenMain.*;
...
//    private TrajectorySequence trajectory;
    ...
    private final RRPathGenMain Main;
...
//        renderBackgroundSplines();
    ...
    public DrawPanel(LinkedList<NodeManager> managers, RRPathGenMain Main, ProgramProperties props) {
        super();
        this.robot = props;
    ...
    public void paintComponent (Graphics g){
        ...
        g.drawImage(new ImageIcon(Objects.requireNonNull(RRPathGenMain.class.getResource("/field-2024-into-the-deep-juice-dark.jpg"))).getImage(), 0, 0, this.getWidth(), this.getHeight(), null);
