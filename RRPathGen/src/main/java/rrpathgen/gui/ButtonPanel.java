...
public class ButtonPanel extends JPanel {
    ...
    private RRPathGenMain main;
    private ProgramProperties robot;

    public ButtonPanel(LinkedList<NodeManager> managers, RRPathGenMain main, ProgramProperties props){
        this.robot = props;
        this.main = main;
    ...
    public void export(){
        ...
        String exportString = RRPathGenMain.drawPanel.getTrajectory().constructExportString();
